...
from tools.memoize import MemoizeTool
from logger import get_logger
from pydantic import ValidationError

from schemas import ToolAction, FinishAction
from errors import (
    InvalidJSONError,
    MissingActionError,
    UnknownActionError,
...
"""
        ...
        for step in range(self.max_steps):
            ...
            try:
                ...
                if isinstance(action, ToolAction):
                    ...
                    is_new = state.register_tool_call(
                        action.tool_name,
                        action.args
                    )
    ...
    def _handle_tool(self, action: ToolAction) -> Dict[str, Any]:
        ...
        if tool is None:
            ...
            raise UnknownToolError(
                ...
                f"Valid tool_name values are: {available}"
            )
    ...
    def _validate_input(self, text: str) -> ToolAction | FinishAction:
        ...
        try:
            ...
            raise InvalidJSONError("Invalid JSON from model. You must return ONE JSON object only.")

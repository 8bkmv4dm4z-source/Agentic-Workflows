...
def main() -> None:
    ...
    parser.add_argument("--checkpoint-db", default=DEFAULT_CHECKPOINT_DB, help="Path to checkpoint sqlite db")
    ...
    parser.add_argument("--run-id", default="", help="Optional run id to print detailed tool step table")

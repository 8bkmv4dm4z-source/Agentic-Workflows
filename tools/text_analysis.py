...
_STOP_WORDS = frozenset({
    ...
    "then", "than", "as", "up", "out", "about", "into", "over", "after",
    "i", "me", "my", "we", "our", "you", "your", "he", "she", "they",
    "them", "its", "his", "her", "their", "all", "each", "every", "both",
    "few", "more", "most", "other", "some", "such", "only", "own", "same",
    "just", "also", "very", "even", "how", "what", "which", "who", "when",
    "where", "why", "been", "being", "because", "between", "through",
    "during", "before", "while", "these", "those", "am",
})

_VALID_OPERATIONS = {
    "word_count", "sentence_count", "char_count", "key_terms",
    "complexity_score", "paragraph_count", "avg_word_length",
    "unique_words", "full_report",
}
...
class TextAnalysisTool(Tool):
    ...
    def _complexity_score(self, text: str) -> Dict[str, Any]:
        ...
        return {"complexity_score": score, "level": level, "avg_word_length": round(avg_word_len, 2), "avg_sentence_length": round(avg_sentence_len, 2)}
